...
python [모듈이름] [키워드] [가져올 페이지 숫자] [가져올 기사의 최근 날짜] [결과 파일명.txt]
한 페이지에 10개
"""
...
def main(argv):
    ...
    target_URL = TARGET_URL_BEFORE_KEYWORD + quote(keyword) + TARGET_URL_BEFORE_UNTIL_DATE \
                    + until_date + TARGET_URL_REST
